...
local CCTYPE_HOJ = "hoj"  --Hammer of Justice制裁之锤
...
GhostRecon.ccList = {
	...
	[CCTYPE_BLIND] = { [2094] = true },  --盗贼致盲
	[CCTYPE_GOUGE] = { [1776] = true },  --盗贼凿击
	...
	[CCTYPE_SHACKLE] = { [9484] = true,[111673] = true },  --牧师束缚亡灵，死骑控制亡灵
	[CCTYPE_MINDCONTROL] = { [605] = true, [205364] = true },  --牧师精神控制、统御意志
	[CCTYPE_TURNEVIL] = { [10326] = true },  --圣骑士超度邪恶
	...
	[CCTYPE_EXHAUSTION] = { [334275] = true, [702] = true },  --疲劳诅咒、虚弱诅咒
	...
	[CCTYPE_REPENTANCE] = { [20066] = true }, --圣骑士忏悔
	[CCTYPE_PSYCHIC_HORROR] = { [64044] = true }, --牧师 心灵惊骇
	[CCTYPE_PSYCHIC_SCREAM] = { [8122] = true }, --牧师 心灵尖啸
	[CCTYPE_HOLYWRATH] = { [2812] = true },  --圣骑士 谴责
	[CCTYPE_HOJ] = { [853] = true, [115750] = true },  --圣骑士 制裁之锤、盲目之光
